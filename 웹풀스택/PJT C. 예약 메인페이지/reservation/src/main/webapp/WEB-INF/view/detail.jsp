                        ...
                        <div>
                            <div class="container_visual" style="width: 414px;">
                                <ul class="visual_img detail_swipe">
                                	<c:forEach var="productImage" items="${displayInfo.productImages}" varStatus="status">
                                		<p>${productImage}</p>
	                                    <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="/reservation/img/${productImage.fileName}"> <span class="img_bg"></span>
