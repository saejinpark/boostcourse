...
public class ReservationCommentImageDao {
    ...
    private RowMapper<ReservationCommentImage> rowMapper = BeanPropertyRowMapper.newInstance(ReservationCommentImage.class);
    ...
    public void insertReservationCommentImage(
