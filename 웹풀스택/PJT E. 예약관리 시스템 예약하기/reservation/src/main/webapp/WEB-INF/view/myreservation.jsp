...
<body>
				...
				<div class="my_summary">
					<ul class="summary_board">
						<li class="item">
							...
							<a href="javascript:void(0);" onclick="activeTotalTab()" class="link_summary_board on">
								<i class="spr_book2 ico_book2"></i>
								<em class="tit">전체</em> <span class="figure">6</span>
							</a>
						</li>
						<li class="item">
							<a href="javascript:void(0);" onclick="activeConfirmedTab()" class="link_summary_board">
								<i class="spr_book2 ico_book_ss"></i> <em class="tit">이용예정</em>
								<span class="figure">2</span>
							</a>
						</li>
						<li class="item"><a href="javascript:void(0);" class="link_summary_board" onclick="activeUsedTab()">
								<i class="spr_book2 ico_check"></i> <em class="tit">이용완료</em> <span
								class="figure">2</span>
						</a></li>
						<li class="item"><a href="javascript:void(0);" class="link_summary_board"  onclick="activeUsedCancelTab()">
	...
	<div class="popup_booking_wrapper" style="display: none;">
		...
		<div class="popup_booking refund">
			...
			<!-- 닫기 -->
			<a href="javascript:void(0);" class="popup_btn_close" title="close"> <i
	...
	<script type="text/template" id="cardItem">
		<article class="card_item">
			<a href="#" class="link_booking_details">
				<div class="card_body">
					...
					<div class="middle">
						<div class="card_detail">
							...
							<h4 class="tit">{{categoryName}}<br />{{description}}</h4>
							<ul class="detail">
								<li class="item"><span class="item_tit">일정</span> <em
									class="item_dsc">{{date}}</em></li>
								<li class="item"><span class="item_tit">내역</span> <em
									class="item_dsc"> {{createDate}} </em></li>
								<li class="item"><span class="item_tit">장소</span> <em
							...
							<div class="price_summary">
								<span class="price_tit">결제 예정금액</span> <em
									class="price_amount"> <span>{{payment}}</span> <span
									class="unit">원</span>
								</em>
							</div>
							<!-- [D] 예약 신청중, 예약 확정 만 취소가능, 취소 버튼 클릭 시 취소 팝업 활성화 -->
							<div class="booking_cancel">
								{{#if confirmed}}
									<button class="btn" data-method="DELETE" data-id="{{id}}" data-title="{{categoryName}}/{{description}}">
										<span>취소</span>
									</button>
								{{/if}}
								{{#if used}}
