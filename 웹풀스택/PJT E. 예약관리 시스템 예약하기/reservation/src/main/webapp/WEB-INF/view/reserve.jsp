...
<body>
				...
				<div class="section_booking_form">
					<div class="booking_form_wrap">
						<div class="form_wrap">
							...
							<form class="form_horizontal" id="bookingForm">
								...
								<div class="inline_form">
									...
									<div class="inline_control tel_wrap">
										<input type="tel" name="tel" id="tel" pattern="\d{2,3}-\d{4}-\d{4}" class="tel" value=""
	...
	<script type="text/template" id="rv-ticket-qty">
		<div class="qty">
			<div class="count_control">
				<!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
				<div class="clearfix">
			...
			<div class="qty_info_icon">
				...
				<em class="product_dsc">{{discountedPrice}}</em>
			</div>
		</div>
	</script>
	<script>
    const bookingDate = "${sessionScope.bookingDate}";
	</script>
