...
<body class="biz  ko">
	...
	<a href="/reservation" class="top_info_close" data-tst_alt_close="0"> <i
		...
		<div class="booking_login">
			...
			<div>
				<form name="confirm_form" class="ng-pristine ng-valid" id="form1"
					method="POST" action="bookinglogin">
	...
	<footer aria-hidden="false">
		...
		<div class="gototop" aria-hidden="false">
			<a href="/reservation" class="lnk_top"> <span
