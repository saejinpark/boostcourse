...
import static org.edwith.webbe.reservation.dao.ReservationInfoPriceDaoSqls.*;
...
public class ReservationInfoPriceDao {
	...
	public Integer insertReservationInfoPrice(Integer reservationInfoId, Integer productPriceId, Integer count) {
