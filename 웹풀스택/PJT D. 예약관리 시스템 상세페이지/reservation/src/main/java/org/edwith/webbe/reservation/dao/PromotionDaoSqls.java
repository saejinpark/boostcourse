...
public class PromotionDaoSqls {
	public static final String SELECT_ALL = "SELECT promotion.id id, product.id productId, pm.id productImageId, c.id categoryId, "
	...
	public static final String SELECT_COUNT_ALL = "SELECT COUNT(*) FROM promotion";
}
